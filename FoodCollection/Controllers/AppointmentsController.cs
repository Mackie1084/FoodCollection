...
namespace FoodCollection.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,Date,Time,Status,CustomerId,StaffId")] Appointment appointment)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.Set<Customer>(), "CustomerId", "CustomerId", appointment.CustomerId);
            ViewData["StaffId"] = new SelectList(_context.Set<Staff>(), "StaffId", "StaffId", appointment.StaffId);
            return View(appointment);
        }
