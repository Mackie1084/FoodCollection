...
namespace FoodCollection.Controllers
{
    public class DeliveryInfoesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["PickupId"] = new SelectList(_context.Set<Pickup>(), "PickupId", "PickupId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("DelilveryInfoId,Date,DeliveryStatus,PickupId,OrganizationId")] DeliveryInfo deliveryInfo)
        {
            ...
            ViewData["OrganizationId"] = new SelectList(_context.Set<Organization>(), "OrganizationId", "OrganizationId", deliveryInfo.OrganizationId);
            ViewData["PickupId"] = new SelectList(_context.Set<Pickup>(), "PickupId", "PickupId", deliveryInfo.PickupId);
            return View(deliveryInfo);
        }
